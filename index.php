...
<html lang="en">
	<head>
	    ...
	    <title>Phong Vu Laptop Home Page</title>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">7 Ngày Đổi Trả Miễn Phí</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Vận Chuyển</h4>
						</div>
					</div>
					<h6 class="text">Miễn Phí Vận CHuyển CHo </h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Giá</h4>
						</div>
					</div>
					<h6 class="text">Giảm Giá Toàn Bộ Sản Phẩm </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">New</h3>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Giá <?php echo htmlentities($row['productPrice']);?> VNĐ			</span>
										     <span class="price-before-discount">Giá Gốc <?php echo htmlentities($row['productPriceBeforeDiscount']);?>	VNĐ</span>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">DELL</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=10 ");
while ($row=mysqli_fetch_array($ret)) 
