...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="100" height="100" alt="">
							</div>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price" style="font-size: 20px;">Giá Ưu Đãi : <?php echo htmlentities($row['productPrice']);?> VNĐ</span>
											<br>
											<span class="price-strike">Giá Gốc: <?php echo htmlentities($row['productPriceBeforeDiscount']);?> VNĐ</span>
										</div>
									</div>
